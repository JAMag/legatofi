...
<div class="searchContainer">
  <h4>Search artist, album or song</h4>
  ...
  <ul class="tracklist">
    ...
    <?php 
      ...
      while($row = mysqli_fetch_array($songsQuery)) {
        ...
        <img class='play' src='assets/images/icons/icons8-play_button_circled.png' onclick='setTrack(\"" . $albumSong->getId() . "\", tempPlaylist, true)'>
